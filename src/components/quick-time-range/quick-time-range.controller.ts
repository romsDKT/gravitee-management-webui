...
class QuickTimeRangeController {
  ...
  constructor(
    ...
    this.timeframes = [
      TimeframeRanges.LAST_5_MINUTES,
      TimeframeRanges.LAST_1_HOUR,
      TimeframeRanges.LAST_12_HOURS,
      TimeframeRanges.LAST_DAY,
      TimeframeRanges.LAST_WEEK,
      TimeframeRanges.LAST_MONTH,
      TimeframeRanges.LAST_3_MONTHS
    ];

    if (!this.timeframe) {
      this.timeframe = TimeframeRanges.LAST_5_MINUTES;
    }
  }
